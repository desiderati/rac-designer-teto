...
export function ConstructionSiteManagementPanel({
  ...
  return (
    <main
      ...
      className='rac-min-width-shell h-full min-h-[480px] min-w-[420px] w-full overflow-x-hidden overflow-y-auto px-0 py-0 sm:overflow-x-auto sm:px-6 sm:py-10 lg:px-10'
...
function scheduleGuidedTourWhenTargetsReady<T>(
  collectTargets: () => T | null,
  dispatchTour: (targets: T) => void,
): () => void {
