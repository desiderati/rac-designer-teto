...
const PRODUCT_SCREENSHOT_URL = '/manus-storage/rac-editor-landing-screenshot-harmonized_95473d21.png';
const HOUSE_ILLUSTRATION_URL = '/manus-storage/teto-house-linework-transparent-cropped_770579e2.png';
