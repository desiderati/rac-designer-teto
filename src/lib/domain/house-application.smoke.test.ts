...
import type {HousePilotiRepository} from "@/lib/domain/house-repository";
import type {DomainPilotiData} from "@/lib/domain/house-use-cases";
import {
  applyPilotiUpdate,
  canAddView,
  getMaxViewCount,
  recalculateRecommendedPilotiData,
} from "@/lib/domain/house-application";
...
function createRepository(seed?: {
  ...
  let pilotis: Record<string, DomainPilotiData> = {
