import {BASE_TOP_HEIGHT, BASE_TOP_WIDTH} from "@/lib/canvas-utils";
import {HouseElement, HouseType} from "@/lib/house-manager";
import {TOP_VIEW_SCALE} from "@/lib/3d/geometry-constants";
