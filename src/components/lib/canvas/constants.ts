...
export const CONTRAVENTAMENTO_STROKE = PILOTI_VISUAL_FEEDBACK_COLORS.emphasizedStrokeColor;
export const CONTRAVENTAMENTO_SELECTED_FILL = PILOTI_MASTER_FILL_COLOR;
export const CONTRAVENTAMENTO_SELECTED_STROKE = PILOTI_VISUAL_FEEDBACK_COLORS.emphasizedStrokeColor;
