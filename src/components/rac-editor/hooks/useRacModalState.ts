...
export type RacSubmenu = "house" | "elements" | "lines" | "overflow" | null;

interface UseRacModalStateResult {
  activeSubmenu: RacSubmenu;
...
export function useRacModalState(): UseRacModalStateResult {
  const [activeSubmenu, setActiveSubmenu] = useState<RacSubmenu>(null);
