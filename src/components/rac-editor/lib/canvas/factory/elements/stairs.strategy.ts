...
import {getHouseScaleFactors} from '@/components/rac-editor/lib/canvas/factory/house/shared.ts';
...
export const stairsStrategy: ElementStrategy = {
  create(canvas: FabricCanvas): CanvasObject {
    ...
    return setCanvasObjectMyType(rect, 'stairs');
  },
};
