...
import {COLORS, HOUSE_3D_VIEWER_SCALE} from '@/components/rac-editor/@viewer-3d/lib/constants.ts';
import type {Stairs3DData} from '@/components/rac-editor/@viewer-3d/lib/parsers/stairs-parser.ts';
import {computeStairs3DPlacement} from '@/components/rac-editor/@viewer-3d/lib/scene-geometry.ts';
