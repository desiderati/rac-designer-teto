...
> `scaffold/dot-agents/examples/repository-overview.example.md`. When installed by
> `agents-bootstrap`, it is copied to `.agents/examples/repository-overview.example.md`.
