---
title: "Regression Run — <título curto da rodada>"
...
# Regression Run — <título curto da rodada>

> Destino sugerido quando a rodada exigir ledger factual de validação:
...
- escopo do comando:
- resultado esperado:
- status real: `pass | fail | partial | not-run`
