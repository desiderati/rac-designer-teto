...
Não existem subpastas `frontend/` ou `backend/` neste momento porque nenhum scaffold atual pertence claramente a essas
famílias. Crie essas pastas apenas quando houver template operacional real para elas.
