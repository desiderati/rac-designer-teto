...
Os mesmos valores alimentam a informação exibida na modal de terreno e a altura usada no cálculo de volume de rachão.

## Cálculo de brita

1. Para cada piloti, o cálculo usa o volume do cilindro externo menos o volume do cilindro do piloti.
